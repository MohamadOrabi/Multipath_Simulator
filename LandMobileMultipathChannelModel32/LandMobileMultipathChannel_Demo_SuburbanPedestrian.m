...
for kk = 1:size(YTic,1)
    oldYTic(kk,:) = [' '];
    newYTic(kk,:) = ['10^',num2str(str2num(cell2mat(YTic(kk,:)))/10),''];
    text(1.2,ax(3)-dta*(kk-1),['10^{',num2str(str2num(cell2mat(YTic(kk,:)))/10),'}'],'interpreter','tex','horizontalalignment','left','verticalalignment','middle');
end
