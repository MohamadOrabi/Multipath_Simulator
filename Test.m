...
n_13 = length(NNError([1:round(runs/3)-1,round(2*runs/3):end]))

NN_RMSE = norm(NNError(round(runs/3):round(2*runs/3)-1))/sqrt(n_2)/fs*c
Narrow_DLL_RMSE = norm(Narrow_DLLError(round(runs/3):round(2*runs/3)-1))/sqrt(n_2)/fs*c
DLL_RMSE = norm(DLLError(round(runs/3):round(2*runs/3)-1))/sqrt(n_2)/fs*c

NN_RMSE = norm(NNError([1:round(runs/3)-1,round(2*runs/3):end]))/sqrt(n_13)/fs*c
Narrow_DLL_RMSE = norm(Narrow_DLLError([1:round(runs/3)-1,round(2*runs/3):end]))/sqrt(n_13)/fs*c
DLL_RMSE = norm(DLLError([1:round(runs/3)-1,round(2*runs/3):end]))/sqrt(n_13)/fs*c
